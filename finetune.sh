#!/bin/bash
# bash finetune.sh 2 Qwen2.5-14B QC
# bash finetune.sh 2 Qwen2.5-14B QI

num_epochs=$1
model=$2
task=$3

output_dir="./models/${model}-finetuned-${task}"
data_path="./outputs/preprocessed/train_${task}_final.txt"
