...
def run_vllm(in_path: str, out_path: str,
    ...
    # vLLM 배치 생성 (모두 한 번에 가능, 내부에서 효율적으로 continuous batching)
...
if __name__ == "__main__":
    main()
'''
CUDA_VISIBLE_DEVICES=0 python run_vllm_generation.py \
    --input ./outputs/train_QI_with_prompts_v2.jsonl
    --output ./outputs/train_generations_vllm_v2.jsonl

CUDA_VISIBLE_DEVICES=1 python run_vllm_generation.py \
    --input ./outputs/dev_QI_with_prompts_v2.jsonl
    --output ./outputs/dev_generations_vllm_v2.jsonl
'''